...
{
    public class DeepSpaceBackground
    {
        ...
        public DeepSpaceBackground()
        {
            ...
            for (int i = 0; i < starcount; i++)
            {
                ...
                if (colorIndex == 1)
                        {
                            colors[i] = Color.FromArgb(30, 100, 100, 100);
                            colorIndex = 2;
                        }
                else if (colorIndex == 2)
                        {
                            colors[i] = Color.FromArgb(30, 255,100,100);
                            colorIndex = 3;
                        }
                else if (colorIndex == 3)
                        {
                            colors[i] = Color.FromArgb(30, 100, 100, 255);
                            colorIndex = 1;
                        }
